...
Процедура ПриСозданииОбъекта(Знач Провайдеры = "json")
	...
	ИнтерфейсКонвертацииВСтруктуру = Новый ИнтерфейсОбъекта;
...
Процедура ОбновитьИндексРеализованныхИнтерфейсов(КлассОбъект)
	...
	РезультатПроверки = РефлекторОбъекта.РеализуетИнтерфейс(ИнтерфейсПриемника, Истина);

	ИндексРеализованныхИнтерфейсов.Вставить("ИнтерфейсПриемник", РезультатПроверки);

	РеализованныеМетоды = РефлекторОбъекта.РеализованныеМетодыИнтерфейса(ИнтерфейсКонвертацииВСтруктуру);

	ИндексРеализованныхИнтерфейсов.Вставить("ИнтерфейсКонвертацииВСтруктуру", РеализованныеМетоды);

КонецПроцедуры

Процедура ПроверитьИНтерфейсПровайдера(КлассПровайдера)
