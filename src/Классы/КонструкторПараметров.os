...
#Область Работа_с_конструктором_настройки
...
Функция ИмяВФайле(Знач ДополнительноеИмя) Экспорт
...
Функция Поле(Знач ИмяПоля,
			 ...
			 Знач ИмяВложеннойНастройки = "") Экспорт
...
Функция ОписаниеПоля(Знач ИмяПоля,
	Знач ТипПоля,
	Знач ТипЭлемента = Неопределено,
	Знач ИмяВложеннойНастройки = Неопределено)
