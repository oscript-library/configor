...
Перем ЗначениеПоУмолчанию Экспорт;
...
Функция ОписаниеПоля() Экспорт
	...
	СтруктураВозврата.Вставить("ЗначениеПоУмолчанию", ЗначениеПоУмолчанию);
...
Функция ПолеОбъект(Знач ИмяПоля, Знач ОбъектПоля, Знач СоздаватьПоле = Истина) Экспорт
	...
	Возврат РодительКонструктор.ПолеОбъект(ИмяПоля, ОбъектПоля, СоздаватьПоле);
