...
Функция ПодготовитьТестовыйКласс(ОбщиеПараметры)
	...
	|КонецПроцедуры
	|
	|Процедура ПриУстановкеЗначенияПараметра(Знач ПолныйПутьКлюча, Знач ИмяКлюча, Значение, СтандартнаяОбработка) Экспорт
	|	//Сообщить(""Попал >> ПриУстановкеЗначенияПараметра для параметра: "" + ПолныйПутьКлюча);
	|КонецПроцедуры
	|";
