...
Процедура ТестДолжен_ПроверитьЗаполнениеОтсутствующихПараметров() Экспорт
	...
	ПроверитьРезультат(СтруктураПараметров["Поле"], СтруктураПроверки.Получить("Поле"));
	
	Ожидаем.Что(СтруктураПроверки.Свойство("ОтсутствующееПоле"), "Поле должно присутствовать").Истина();
