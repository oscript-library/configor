...
Функция ПолучитьСписокШагов(КонтекстФреймворкаBDD) Экспорт
	...
	ВсеШаги.Добавить("ДатаПараметраКонструктораРавна");
	ВсеШаги.Добавить("СтрокаПараметраКонструктораРавна");
	ВсеШаги.Добавить("ЧислоПараметраКонструктораРавна");
	ВсеШаги.Добавить("БулевоПараметровКонструктораРавна");
...
//Дата параметра конструктора "" равна ""
Процедура ДатаПараметраКонструктораРавна(Знач ИмяПараметра, Знач ПроверочноеЗначение) Экспорт
	...
	ЗначениеПараметра = Конструктор.Параметр(ИмяПараметра);

	Утверждения.ПроверитьРавенство(ЗначениеПараметра, ПроверочнаяДата, "Результат должен совпадать с ожиданиями");

КонецПроцедуры

//Строка параметра конструктора "" равна ""
Процедура СтрокаПараметраКонструктораРавна(Знач ИмяПараметра, Знач ПроверочноеЗначение) Экспорт
...
//Число параметра конструктора "" равна ""
Процедура ЧислоПараметраКонструктораРавна(Знач ИмяПараметра, Знач ПроверочноеЗначение) Экспорт
...
//Булево параметров конструктора "" равна ""
Процедура БулевоПараметровКонструктораРавна(Знач ИмяПараметра, Знач ПроверочноеЗначение) Экспорт
